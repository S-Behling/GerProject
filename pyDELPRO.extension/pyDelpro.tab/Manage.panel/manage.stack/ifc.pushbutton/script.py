...
#pegar parametros do elemento > Teste p/ colunas
# allProjParam = []
# for projPar in RVTColumns:
...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self) -> None:
        ...
        def SelectPath():
            ...
            elements = self.ifc_file.by_type('IfcColumn')
        ...
        def PopulateSelectParametersRVT():
            ...
            #NÃO ESTA FUNCIONANDO PARA COLUNA
            allParam1 = []
        ...
        def PopulateElementsTable(elements):
            ...
            for e in elements:
                ...
                #self.tableWidget_all.setItem(rowPosition , 2, QTableWidgetItem(e.Name))
